...
@section('js')
    ...
    <script>
        ...
        $(document).on("click", ".open-infoDialog", function () {
            ...
            $(".modal-body #modal_permanent_address").html('&nbsp' + add1 + ', ' + add2 + ', ' + add3 + ', ' + add4);
...
@section('content')
    ...
    <div class="well span8">
            ...
            <div class="form-group{{ $errors->has('csv_file') ? ' has-error' : '' }}">
                ...
                <div class="row-fluid" style ="margin-left: 45px;">
                    ...
                    <div class="span4 row-fluid">
                        ...
                        <a href="{{  URL::Route('showTable') }}">Show Added Data</a>
                    </div>
        ...
        <div class="modal fade modal-lg" id="registerDialog" tabindex="-1" role="dialog">
                    ...
                    <div class="modal-body">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>A/L Batch</td>
                                <td> :</td>
                                <td><div id="modal_al_batch"></div></td>
                            </tr>
                            <tr>
                                <td>Current Batch</td>
                                <td> :</td>
